...
// Primary phone (Germany) — call/message
const PHONE_NUMBER = '+491605718168';
const PHONE_DISPLAY = '+49 160 5718168';
      ...
      <div className="container">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <div className="mt-3 flex items-start gap-3">
            ...
            <span className="text-on-deep/75 text-sm leading-relaxed">{t.contact.available_from}</span>
          </div>
        </div>
          ...
          <div className="space-y-8">
            <div className="space-y-0">
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-[10px] text-on-deep/65 tracking-widest uppercase mb-0.5">{t.contact.phone_label}</p>
